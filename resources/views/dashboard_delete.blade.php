...
<body class="bg-gray-100 text-gray-800 min-h-screen flex">
    ...
    <!-- Main content -->
    <div class="flex flex-col items-center justify-center w-4/5 max-w-4xl p-10 mx-auto my-auto form-container">
        <h1 class="text-4xl font-bold mb-8 text-center">Delete Movie</h1>
        <form action="#" method="GET" class="w-full">
            ...
            <div class="text-center">
                <button class="w-full py-4 rounded transition duration-300 hover:bg-blue-600 hover-shadow" type="submit" onclick="openPopup()">Delete Movie</button>
                <div class="popup" id="popup">
                        
                    <h2>Thank You</h2>
                    <p>Movie Deleted Successfully
                    </p>
